...
const tabs = [
  { id: "overview", label: "Overview", icon: LayoutDashboard, active: true, variant: "default" },
  { id: "reports", label: "Reports", icon: BarChart3, active: false, variant: "primary" },
  { id: "questions", label: "Questions", icon: MessageCircle, active: false, variant: "default" },
];
